...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $escoteiro = new MODEL\escoteiro((int)$_POST['id_escoteiro'], $_POST['nome'], $_POST['data_nascimento'], $_POST['nome_responsavel'], $_POST['telefone_responsavel'], 0, $_POST['status']);
